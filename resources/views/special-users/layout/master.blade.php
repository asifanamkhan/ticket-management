...
<div class="top-bar-boxed border-b border-theme-2 -mt-7 md:-mt-5 -mx-3 sm:-mx-8 px-3 sm:px-8 md:pt-0 mb-12">
    <div class="h-full flex items-center">
        ...
        <!-- END: Logo -->
        <!-- BEGIN: Breadcrumb --> 
        <div class="-intro-x breadcrumb mr-auto"> <a href="{{ route('special-user.home') }}">Profile</a> <i data-feather="chevron-right" class="breadcrumb__icon"></i> <a href="" class="breadcrumb--active">Edit</a> </div>
        <!-- END: Breadcrumb -->
        <!-- BEGIN: Search -->
            ...
            <div class="dropdown-menu w-56">
                <div class="dropdown-menu__content box bg-theme-11 dark:bg-dark-6 text-white">
                    <div class="p-4 border-b border-theme-12 dark:border-dark-3">
                        ...
                        <div class="text-xs text-theme-13 mt-0.5 dark:text-gray-600">Special User</div>
                    </div>
                    <div class="p-2">
                        <a href="{{ route('special-user.home') }}" class="flex items-center block p-2 transition duration-300 ease-in-out hover:bg-theme-1 dark:hover:bg-dark-3 rounded-md"> <i data-feather="user" class="w-4 h-4 mr-2"></i> Profile </a>
                        <!-- <a href="" class="flex items-center block p-2 transition duration-300 ease-in-out hover:bg-theme-1 dark:hover:bg-dark-3 rounded-md"> <i data-feather="edit" class="w-4 h-4 mr-2"></i> Add Account </a> -->
                        <a href="{{ route('special-user.password.change', ['id' => auth()->user()->id]) }}" class="flex items-center block p-2 transition duration-300 ease-in-out hover:bg-theme-1 dark:hover:bg-dark-3 rounded-md"> <i data-feather="lock" class="w-4 h-4 mr-2"></i> Reset Password </a>
                    ...
                    <div class="intro-y box mt-5">
                        <div class="relative flex items-center p-5">
                            ...
                            <div class="ml-4 mr-auto">
                                <div class="font-medium text-base">{{ auth()->user()->full_name }}</div>
                                <div class="text-gray-600">Special User</div>
                            </div>
                            <!-- <div class="dropdown">
                        ...
                        <div class="p-5 border-t border-gray-200 dark:border-dark-5">
                            ...
                            <a class="flex items-center {{ request()->is('special-user*') ? 'text-theme-17 dark:text-gray-300 font-medium' : ''}}" href="{{route('special-user.home')}}"> <i data-feather="activity" class="w-4 h-4 mr-2"></i> Personal Information </a>
                            @endif
                            ...
                            <a class="flex items-center mt-5 {{ request()->is('special-user/password-change*') ? 'text-theme-17 dark:text-gray-300 font-medium' : ''}}" href="{{ route('special-user.password.change', ['id' => auth()->user()->id]) }}"> <i data-feather="lock" class="w-4 h-4 mr-2"></i> Change Password </a>
